...
<div class="panel panel-primary">
    ...
    <tbody>
        <?php
        $get = $con->query("SELECT * FROM `study_material` where type = 'video_training'");
        $i = 1;
        if ($get->num_rows) {
            while ($row = $get->fetch_assoc()) {
                ...
                echo '</td>
                        ...
                        <td>
                            ...
                            <a href="'.BASE_URL.'uploads/study_material/' . $row['file'] . '" download target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Download</a>
                             </td>
                      </tr>';
            }
        }
