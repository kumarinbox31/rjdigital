...
{
    $con->query("INSERT INTO `student_messages` (`id`, `timestamp`, `student_id`, `message`) VALUES (NULL, CURRENT_TIMESTAMP, '".$_GET['id']."', '".$_POST['message']."')");
    echo '<script>location.href="notification.php?id='.$_GET['id'].'"</script>';
}
$get = $con->query("SELECT * FROM students where id = '".$_GET['id']."'")->fetch_assoc();
if($_GET['action']=='del')
{
...
<div class="box box-warning">
    <div class="box-header"><h3>Send Message for (<?=ucwords($get['name'])?>)</h3></div>
    <div class="box-body">
    ...
    <div class="box-footer">
        <table class="table table-striped">
            ...
            <tbody>
                <?
                    $mess = $con->query("SELECT * FROM student_messages where student_id = '".$_GET['id']."' order by id desc");
