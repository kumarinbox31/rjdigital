               ...
               <div class="column col-lg-8 col-md-8 col-sm-12 col-xs-12">
                  <center>
                     ...
                     <ul class="list-inline sm-pull-none sm-text-center text-white mb-sm-20 mt-10"
                        style="font-size:14px;padding-inline-start: 1px;">
                        <!--<li class=" pl-10"><a href="contact-us.html" class="text-black"> Enquiry Here</a></li>-->
                        <li class=" pl-10"><a href="<?= BASE_URL ?>list_center.php" class="text-black">Franchise
                              Details</a></li>
                        <li class=" pl-10"><a href="<?= BASE_URL ?>franchisee_form.php" class="text-black">Apply
                              Franchise</a></li>
                        <li class=" pl-10"><a href="<?= BASE_URL ?>center_login.php" target="_blank"
                              class="text-black">Franchise Login</a></li>
                        <li class=" pl-10"><a href="<?= BASE_URL ?>admin" target="_blank" class="text-black"> Admin
                              Login</a></li>
                        <li class="pl-10"><a href="<?= BASE_URL ?>student_login.php" class="text-black">Student Login</a>
                        </li>
               ...
               <div class="column col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <center>
                     <ul class="links-nav clearfix" style="margin-top:10px;">
                        <li><a href="tell:<?= $headerMobile ?>" target="_blank" style="color:#fff;"><span
                                 class=" fa fa-phone"></span><?= $headerMobile ?></a></li>
                        <li><a href="<?= $headerFacebook ?>" target="_blank"><span class=" fa fa-facebook"></span></a>
                        </li>
         ...
         <div class="header-lower">
            <div class="auto-container">
               <div class="nav-outer clearfix">
                  ...
                  include 'navbar.php';
                  ?>
                  <div class="btn-outer"><a href="/franchisee_form.php" class="theme-btn quote-btn"><span
                           class="fa fa-user"></span> Apply Franchise </a></div>
               </div>
            </div>
         </div>
         <!--Header-Lower-->
         ...
         <div class="sticky-header">
            <div class="auto-container clearfix">
               ...
               <div class="logo pull-left">
                  <a href="/" class="img-responsive"><img src="uploads/logo/<?= $logo['logo'] ?>" width="300px"
                        alt="Digital Computer institute"></a>
               </div>
               <!--Right Col-->
