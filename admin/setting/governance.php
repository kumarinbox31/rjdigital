            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="governance_title" class="form-control" value="<?=isset($setting['governance_title'])?$setting['governance_title']:'e-Governance @UGC';?>">
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <?
        $type= 'governance_links';
        ?>
        <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="<?=$type?>">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Add governance Item </strong>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
    ...
    <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>governance Items</strong>
                </div>
                <div class="box-body">
