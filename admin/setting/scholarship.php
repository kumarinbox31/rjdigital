            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="scholarship_title" class="form-control" value="<?=isset($setting['scholarship_title'])?$setting['scholarship_title']:'Scholarship/Fellowships';?>">
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <?
        $type= 'scholarship_links';
        ?>
        <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="<?=$type?>">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Add Scholarship Item </strong>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
    ...
    <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Scholarship Items</strong>
                </div>
                <div class="box-body">
