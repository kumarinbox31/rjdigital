            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="schemes_title" class="form-control" value="<?=isset($setting['schemes_title'])?$setting['schemes_title']:'Schemes @UGC';?>">
                    </div>
                </div>
