            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="student_corner_title" class="form-control" value="<?=isset($setting['student_corner_title'])?$setting['student_corner_title']:'Student Corner';?>">
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <?
        $type= 'student_corner_links';
        ?>
        <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="<?=$type?>">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Add Student Corner Item </strong>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
    ...
    <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Student Corner Items</strong>
                </div>
                <div class="box-body">
