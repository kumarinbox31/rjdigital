            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="covid_info_title" class="form-control" value="<?=isset($setting['covid_info_title'])?$setting['covid_info_title']:'COVID-19 Initiatives @ UGC';?>">
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <?
        $type= 'covid_info_links';
        ?>
        <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="<?=$type?>">
            <div class="box box-primary">
                <div class="box-header">
                    <strong>Add Covid Item </strong>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
