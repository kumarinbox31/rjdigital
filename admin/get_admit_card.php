...
if($_POST['status']=='admit_card')
{
	...
	if($stu->num_rows>0 && $admit->num_rows>0)
	{
		...
		$exam_date = date("d-m-Y",strtotime($a['exam_date']));
				...
				<div class="box-body" id="printableArea">
					<table class="table table-bordered">
						<tbody>
							...
							<tr><th>Center Name</th> <td><?=$a['exam_center']?></td></tr>
							<tr><th>Exam Date</th> <td><?=$a['exam_date']?></td></tr>
							<tr><th>Exam Time</th> <td><?=$a['exam_time']?></td></tr>
						</tbody>
					</table>
				</div>
